...
const ROIHeroSection = () => {
  ...
  const cards = [
    ...
    { label: "Ganho Líquido (Ano 1)", usd: results.ganhoLiquido, mzn: results.ganhoLiquidoMZN },
  ];

  return (
    <section className="py-20 md:py-28 bg-primary text-primary-foreground px-6 md:px-12 lg:px-24">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-sm tracking-widest uppercase opacity-60 mb-8">ROI Cenário Realista</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-10">
          ...
          >
            <p className="text-xs opacity-50 mb-2">ROI</p>
        ...
        <p className="text-sm opacity-60 max-w-lg mx-auto">
          Com o cenário realista, o Grupo Webcore recupera o investimento em menos de {results.paybackMeses.toFixed(1)} meses, gerando um retorno de {formatPercent(results.roiPercent)} no primeiro ano.
        </p>
      </div>
    </section>
  );
